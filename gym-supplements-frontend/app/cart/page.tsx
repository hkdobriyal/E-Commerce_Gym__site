...
// // //   const userId = useSelector((state) => state.auth.user?.id); // Get userId from auth state
...
// // //   if (error) {
// // //     return <p className="text-red-500">Error loading cart items.</p>;
// // //   }
...
import { useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { fetchCartItems, setCartItems } from "@/app/redux/slices/cartSlice";
import { useRouter } from "next/navigation";
import CartItem from "../components/CartItem";
